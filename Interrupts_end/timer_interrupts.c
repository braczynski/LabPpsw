...
__irq void Timer0IRQHandler(){
	...
	T0IR=mMR0_INTERRUPT; 	// skasowanie flagi przerwania //2
	ptrTimer0InterruptFunction();		// cos do roboty //3
	VICVectAddr=0x00; 	// potwierdzenie wykonania procedury obslugi przerwania //5
}
/**********************************************/
